...
sentiment using TF-IDF features and Support Vector Machine.
...
# Use CalibratedClassifierCV to get probability estimates from LinearSVC
base_model = LinearSVC(random_state=42, max_iter=10000)
# Use cv=min(3, num_samples_per_class) to handle small datasets
...
print("\nSVM sentiment model trained and saved.")
